...
{
    public class BangCongContext : DbContext
    {
        // Tùy chỉnh đường dẫn từng máy
        ...
        public BangCongContext()
        {
        }

        public BangCongContext(DbContextOptions<BangCongContext> options) : base(options)
        {
        }
